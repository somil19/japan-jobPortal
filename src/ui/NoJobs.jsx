...
export default function NoJobs() {
  return (
    <div className="flex flex-col items-center">
      <div className="bg-purple-200 p-4  rounded-full w-fit">
        <svg
      ...
      <h1 className="md:text-2xl text-center text-xl">
        Sorry, we couldn't find any results. Please try different search terms.{" "}
      </h1>
    </div>
  );
}
